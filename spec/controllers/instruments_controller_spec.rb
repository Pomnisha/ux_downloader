...
describe InstrumentsController do
  ...
  describe "GET show" do
    it "assigns the requested instrument as @instrument" do
      instrument = Instrument.create! valid_attributes
      get :show, {:id => instrument.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested instrument as @instrument" do
      instrument = Instrument.create! valid_attributes
      get :edit, {:id => instrument.to_param}, valid_session
      assigns(:instrument).should eq(instrument)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Instrument" do
        expect {
          post :create, {:instrument => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved instrument as @instrument" do
        ...
        post :create, {:instrument => { "id" => "invalid value" }}, valid_session
        assigns(:instrument).should be_a_new(Instrument)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested instrument" do
        ...
        Instrument.any_instance.should_receive(:update_attributes).with({ "id" => "1" })
        put :update, {:id => instrument.to_param, :instrument => { "id" => "1" }}, valid_session
      end

      it "assigns the requested instrument as @instrument" do
        instrument = Instrument.create! valid_attributes
        put :update, {:id => instrument.to_param, :instrument => valid_attributes}, valid_session
        assigns(:instrument).should eq(instrument)
      end
    ...
    describe "with invalid params" do
      it "assigns the instrument as @instrument" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Instrument.any_instance.stub(:save).and_return(false)
        put :update, {:id => instrument.to_param, :instrument => { "id" => "invalid value" }}, valid_session
        assigns(:instrument).should eq(instrument)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested instrument" do
      instrument = Instrument.create! valid_attributes
      expect {
        delete :destroy, {:id => instrument.to_param}, valid_session
      }.to change(Instrument, :count).by(-1)
    end
